...
<head>
    ...
    <title>Error 400 - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
                            ...
                            <div class="card-content">
                                <div class="row py-2">
                                    <div class="col-12 col-sm-12 col-md-12 mb-1">
                                        <a href="/dashboard" class="btn btn-primary btn-block"><i class="ft-home"></i> Beranda</a>
                                    </div>
                                </div>
                            </div>
                        </div>
