...
<head>
    ...
    <title>Error 500 - Sedang Dalam Gangguan</title>
    <link rel="apple-touch-icon" href="{{asset('app-assets/images/logo.png')}}">
...
<body class="horizontal-layout horizontal-menu horizontal-menu-padding material-horizontal-layout material-layout 1-column   blank-page" data-open="click" data-menu="horizontal-menu" data-col="1-column">
    <!-- BEGIN: Content-->
                            ...
                            <div class="card-content">
                                <div class="row py-2">
                                    <div class="col-12 col-sm-12 col-md-12 mb-1">
                                        <a href="/dashboard" class="btn btn-primary btn-block"><i class="ft-home"></i> Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
